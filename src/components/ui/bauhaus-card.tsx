...
export const BauhausCard: React.FC<BauhausCardProps> = ({
  ...
  onMoreOptionsClick,
  mirrored = false,
  ChronicleButtonHoverColor = "#0076CE",
  textColorTop = "#bfc7d5",
  textColorMain = "#ffffff",
  textColorSub = "rgba(255,255,255,0.65)",
  ...
  return (
    ...
    >
      ...
      <div className="bauhaus-card-body">
        ...
        {showProgress && progressBarInscription && (
      ...
      {showButtons && (filledButtonInscription || outlinedButtonInscription) && (
        <div className="bauhaus-card-footer">
          <div className="bauhaus-button-container">
            {swapButtons ? (
              <>
                {outlinedButtonInscription && onOutlinedButtonClick && (
                  <ChronicleButton
                ...
                {filledButtonInscription && onFilledButtonClick && (
                  <ChronicleButton
