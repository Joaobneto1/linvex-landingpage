                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="hidden lg:flex items-center justify-center">
                            <div className="w-full max-w-md aspect-square rounded-3xl bg-gradient-to-br from-[#0076CE]/20 to-[#0099FF]/10 border border-white/10 flex items-center justify-center">
                                <Code2 className="w-32 h-32 text-[#0076CE]/50" />
                            </div>
                        </div>
                    </div>
                </div>
